...
class CourseController extends AbstractController
{
    ...
    public function view(Course $course, EntityManagerInterface $em): Response
    {
    ...
    public function edit(Course $course, EntityManagerInterface $em, Request $request): Response
    {
